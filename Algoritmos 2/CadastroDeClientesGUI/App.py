...
class Application:
    def __init__(self, master=None):
        ...
        self.lblcpfb = Label(self.container2, text="CPF:", font=self.fonte, width=10)
        self.lblcpfb.pack(side=LEFT)

        self.txtcpfb = Entry(self.container2)
        self.txtcpfb["width"] = 10
        self.txtcpfb["font"] = self.fonte
        self.txtcpfb.pack(side=LEFT)
    ...
    def buscarUsuario(self):
        ...
        cpf = self.txtcpfb.get()

        self.lblmsg["text"] = user.selectUser(cpf)

        self.txtcpfb.delete(0, END)
        self.txtcpfb.insert(INSERT, user.cpf)
